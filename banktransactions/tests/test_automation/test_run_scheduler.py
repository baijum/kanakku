...
class TestRunScheduler:
    ...
    def test_main_success_single_iteration(self, mock_sleep, mock_scheduler_class,
    ...
    @patch('banktransactions.email_automation.run_scheduler.EmailScheduler')
    @patch('banktransactions.email_automation.run_scheduler.time.sleep')
    def test_main_keyboard_interrupt_immediate(self, mock_sleep, mock_scheduler_class,
                                             mock_create_db_session, mock_redis_from_url, mock_parser_class):
    ...
    @patch('banktransactions.email_automation.run_scheduler.EmailScheduler')
    @patch('banktransactions.email_automation.run_scheduler.time.sleep')
    def test_main_scheduler_exception_recovery(self, mock_sleep, mock_scheduler_class,
                                             mock_create_db_session, mock_redis_from_url, mock_parser_class):
    ...
    @patch('banktransactions.email_automation.run_scheduler.EmailScheduler')
    @patch('banktransactions.email_automation.run_scheduler.time.sleep')
    def test_main_default_arguments(self, mock_sleep, mock_scheduler_class,
                                  mock_create_db_session, mock_redis_from_url, mock_parser_class):
    ...
    @patch('banktransactions.email_automation.run_scheduler.EmailScheduler')
    @patch('banktransactions.email_automation.run_scheduler.time.sleep')
    def test_main_custom_interval(self, mock_sleep, mock_scheduler_class,
                                 mock_create_db_session, mock_redis_from_url, mock_parser_class):
    ...
    @patch('banktransactions.email_automation.run_scheduler.EmailScheduler')
    @patch('banktransactions.email_automation.run_scheduler.time.sleep')
    def test_main_multiple_iterations(self, mock_sleep, mock_scheduler_class,
                                    mock_create_db_session, mock_redis_from_url, mock_parser_class):

...
def debug_encryption():
    ...
    with app.app_context():
        ...
        print(f"Encryption key length: {len(encryption_key) if encryption_key else 'None'}")
        print()
        ...
        try:
            ...
            print(f"Encryption/decryption test: {'✓ PASSED' if decrypted == test_password else '✗ FAILED'}")
        ...
        try:
            ...
            if config:
                ...
                print(f"  App password length: {len(config.app_password) if config.app_password else 'None'}")
                print()
                ...
                try:
                    ...
                    print(f"Re-encryption test: {'✓ PASSED' if new_decrypted == dummy_password else '✗ FAILED'}")

...
A Model Context Protocol server that provides administrative access to Kanakku
production systems for debugging and monitoring purposes. This server allows
Cursor to read various log files, monitor services, and execute safe system
...
logger = logging.getLogger("kanakku-admin-server")

# Server configuration
server = Server("kanakku-admin-server")
...
LOG_PATHS = {
    ...
    "systemd_kanakku_admin_server": "journalctl -u kanakku-admin-server",
    "systemd_kanakku_dashboard": "journalctl -u kanakku-dashboard",
    ...
    async with mcp.server.stdio.stdio_server() as (read_stream, write_stream):
        await server.run(
            ...
            InitializationOptions(
                server_name="kanakku-admin-server",

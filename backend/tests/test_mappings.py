...
from app.models import BankAccountMapping, ExpenseAccountMapping, Book, User
...
class TestBankAccountMappings:
    ...
    def test_get_bank_account_mappings_success(self, authenticated_client, user, db_session):
    ...
    def test_get_bank_account_mappings_with_book_id(self, authenticated_client, user, db_session):
        ...
        response = authenticated_client.get(f"/api/v1/bank-account-mappings?book_id={book2.id}")
    ...
    def test_get_bank_account_mappings_no_active_book(self, authenticated_client, user, db_session):
    ...
    def test_create_bank_account_mapping_success(self, authenticated_client, user, db_session):
        ...
        response = authenticated_client.post("/api/v1/bank-account-mappings", json=mapping_data)
    ...
    def test_create_bank_account_mapping_with_book_id(self, authenticated_client, user, db_session):
    ...
    def test_create_bank_account_mapping_no_data(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/v1/bank-account-mappings", 
    ...
    def test_create_bank_account_mapping_no_book(self, authenticated_client, user, db_session):
    ...
    def test_create_bank_account_mapping_book_not_found(self, authenticated_client, user, db_session):
    ...
    def test_create_bank_account_mapping_database_error(self, authenticated_client, user, db_session):
    ...
    def test_update_bank_account_mapping_success(self, authenticated_client, user, db_session):
        ...
        response = authenticated_client.put(f"/api/v1/bank-account-mappings/{mapping.id}", json=update_data)
    ...
    def test_update_bank_account_mapping_partial(self, authenticated_client, user, db_session):
    ...
    def test_update_bank_account_mapping_not_found(self, authenticated_client):
        ...
        response = authenticated_client.put("/api/v1/bank-account-mappings/99999", json=update_data)
        
        assert response.status_code == 404
        data = json.loads(response.data)
        assert data["error"] == "Mapping not found or unauthorized"

    def test_update_bank_account_mapping_no_data(self, authenticated_client, user, db_session):
        ...
        response = authenticated_client.put(f"/api/v1/bank-account-mappings/{mapping.id}",
                                          headers={"Content-Type": "application/json"})
    ...
    def test_delete_bank_account_mapping_success(self, authenticated_client, user, db_session):
        ...
        response = authenticated_client.delete(f"/api/v1/bank-account-mappings/{mapping_id}")
...
class TestExpenseAccountMappings:
    ...
    def test_get_expense_account_mappings_success(self, authenticated_client, user, db_session):
        ...
        assert data["expense_account_mappings"][0]["ledger_account"] == "Expenses:Food:Coffee"

    def test_create_expense_account_mapping_success(self, authenticated_client, user, db_session):
        ...
        response = authenticated_client.post("/api/v1/expense-account-mappings", json=mapping_data)
    ...
    def test_update_expense_account_mapping_success(self, authenticated_client, user, db_session):
        ...
        response = authenticated_client.put(f"/api/v1/expense-account-mappings/{mapping.id}", json=update_data)
    ...
    def test_delete_expense_account_mapping_success(self, authenticated_client, user, db_session):
        ...
        response = authenticated_client.delete(f"/api/v1/expense-account-mappings/{mapping_id}")
...
class TestMappingsImportExport:
    ...
    def test_import_mappings_success(self, authenticated_client, user, db_session):
        ...
        response = authenticated_client.post("/api/v1/mappings/import", json=import_data)
    ...
    def test_import_mappings_update_existing(self, authenticated_client, user, db_session):
    ...
    def test_import_mappings_no_data(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/v1/mappings/import",
                                           headers={"Content-Type": "application/json"})
    ...
    def test_export_mappings_success(self, authenticated_client, user, db_session):
        ...
        assert data["expense-account-map"]["Starbucks"] == ["Expenses:Food:Coffee", "Coffee expenses"]
    ...
    def test_export_mappings_no_active_book(self, authenticated_client, user, db_session):
    ...
    def test_import_mappings_database_error(self, authenticated_client, user, db_session):
        """Test database error during import"""
        from sqlalchemy.exc import SQLAlchemyError
        ensure_user_has_active_book(user, db_session)

        import_data = {
            "bank-account-map": {"XX1234": "Assets:Bank:Test"}
        }
    ...
    def test_export_mappings_database_error(self, mock_query, authenticated_client, user, db_session):
...
class TestMappingsEdgeCases:
    ...
    def test_expense_mapping_import_with_single_value(self, authenticated_client, user, db_session):
    ...
    def test_expense_mapping_import_with_invalid_format(self, authenticated_client, user, db_session):

...
from app.utils.encryption import get_encryption_key, encrypt_value, decrypt_value
...
class TestEncryption:
    ...
    @patch.dict(os.environ, {'ENCRYPTION_KEY': 'G27M7j58p9H2el6A5iJJX0RD0hAJsClDNalxOoI9zA8='})
